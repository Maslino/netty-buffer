...
/**
 * This is a basic thread safe single linked list. It provides very limited functionality. It is
 * small and fast.
 */
public class SingleLinkedList<T> {

    /** The logger */
    private static final InternalLogger log = InternalLoggerFactory.getInstance(SingleLinkedList.class);
